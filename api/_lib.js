...
export async function buildBootstrap(organizationId) {
  ...
  return {
    ...
    boothStaffing: store.boothStaffing.filter((item) => store.booths.some((booth) => booth.id === item.boothId)),
    boothInventoryItems: store.boothInventoryItems.filter((item) => store.booths.some((booth) => booth.id === item.boothId)),
    boothMeetings: store.boothMeetings.filter((item) => store.booths.some((booth) => booth.id === item.boothId)),
    boothIssues: store.boothIssues.filter((item) => store.booths.some((booth) => booth.id === item.boothId)),
